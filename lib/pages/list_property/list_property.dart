...
import 'package:take/Widgets/paralleldropdownlist.dart';
                        ...
                        Consumer<ListProvider>(
                          builder: (context, provider, child) {
                            return true
                                ? InkWell(
                                    onTap: () async {
                                      provider.dataloading = true;
                                      provider.submit(context);
                                      print(
                                          "sdfdddddddddddddddddddddddddddddddddddddddd");
                                      print(provider.dataloading);
                                      print(
                                          "sdfdddddddddddddddddddddddddddddddddddddddd");
